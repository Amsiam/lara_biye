...
rules([
    ...
    'partner.height_from' => 'nullable|numeric|min:50|max:250',
    'partner.height_to' => 'nullable|numeric|min:50|max:250|gte:height_from',
    'partner.weight_from' => 'nullable|numeric|min:30|max:300',
    'partner.weight_to' => 'nullable|numeric|min:30|max:300|gte:weight_from',
