    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            @foreach ($this->packages as $package)
                <div
                    class="relative bg-white rounded-lg shadow-lg overflow-hidden border-2 {{ $package->is_popular ? 'border-custom-pink' : 'border-gray-200' }} hover:shadow-xl transition-shadow duration-300">

                    @if ($package->is_popular)
                        <div
                            class="absolute top-0 right-0 bg-custom-pink text-white px-3 py-1 text-xs font-bold rounded-bl-lg">
                            POPULAR
                        </div>
                    @endif
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <span
                                class="text-4xl font-bold text-gray-900">৳{{ number_format($package->price, 0) }}</span>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center text-gray-700">
                                ...
                                <span class="font-semibold">Connect with {{ $package->connections }} People(s)</span>
                            </div>
