...
<div
    ...
    <!-- Right Section -->
    <div class="w-full lg:w-3/5 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
        <!-- Mobile brand header -->
        <div class="flex items-center justify-center mb-4 lg:hidden">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500">Join thousands of engineers!</p>
            </div>
        </div>

        <div class="mb-5">
            <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-custom-red mb-1">Create your account</h2>
            <p class="text-gray-600 text-sm sm:text-base">Fill in the details below to get started</p>
        </div>
